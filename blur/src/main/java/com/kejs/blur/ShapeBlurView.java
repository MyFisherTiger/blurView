...
import com.kejs.blur.bean.BlurCorner;
import com.kejs.blur.bean.BlurMode;
import com.kejs.blur.impl.AndroidStockBlurImpl;
import com.kejs.blur.impl.AndroidXBlurImpl;
import com.kejs.blur.impl.BlurImpl;
import com.kejs.blur.impl.EmptyBlurImpl;
import com.kejs.blur.impl.SupportLibraryBlurImpl;
...
public class ShapeBlurView extends View {
    ...
    /**
     * 设置高斯模糊的底图基于此view（默认是基于activity的DecorView）
     * 如果自定义view不为空，就以自定义view为基础,指定涂层进行高斯模糊
     * 如果自定义view为空，就以activity的decorView为基础，进行高斯模糊
     * @param view
     */
    public void setBlurBgBase(@Nullable View view) {
...
//        matrix = new Matrix();
    ...
    /**
     * 自定义view不为空，就以自定义view为基础,指定涂层进行高斯模糊
     * 自定义view为空，就以activity的decorView为基础，进行高斯模糊
     *
     * @return View
     */
